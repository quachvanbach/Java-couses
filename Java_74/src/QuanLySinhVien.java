	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("1. Thêm Sinh Viên vào danh sách.\n" + "2. In danh sách Sinh Viên ra màn hình.\n"
					...
					+ "11. Đọc danh sách sinh vien từ tập tin.\n"
			...
			if (luaChon == 1) {
				...
				// 10. Ghi dữ liệu xuống File:1
				System.out.println("Nhập tên File: ");
				String tenFile = "C:\\Users\\quach\\eclipse-workspace\\Java_74\\" + sc.nextLine();
				File f = new File(tenFile);
				danhSachSinhVien.ghiDuLieuXuongFile(f);
			} else if (luaChon == 11) {
				// 11. Đọc danh sách sinh vien từ tập tin.
				System.out.println("Nhập tên File: ");
				String tenFile = "C:\\Users\\quach\\eclipse-workspace\\Java_74\\" + sc.nextLine();
				File f = new File(tenFile);
				danhSachSinhVien.docDuLieuTuFile(f);
			}
		} while (luaChon != 0);
